...
This Mini Library Management System is a Python-based console program that demonstrates the use of core data structures — dictionaries, lists, and tuples — to manage library operations efficiently.

The system allows users to perform essential library functions such as:
- Adding new books and members  
- Searching and updating records  
- Borrowing and returning books  
- Deleting entries safely  

This project follows the CRUD model (Create, Read, Update, Delete) and includes unit tests to validate the core functionalities.
...
### Run using Visual Studio Code (VSC)*
